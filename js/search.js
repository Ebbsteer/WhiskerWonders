...
//------------------Add all products to search, all cards--------------------
window.onload = (event) => {
  ...
  //------------------If search input is changed display only the matching products, all other invisible--------------------
  //------------------If no input in search = no products--------------------
  searchInput.addEventListener("input", (e) => {
    if (searchInput.value == "") {
      ...
      cardElements.forEach((cardInfo) => {
        ...
        cardInfo.element.classList.toggle(
          "hide",
          value == "" ? false : !isVisible
        );
      });
    }
  });
